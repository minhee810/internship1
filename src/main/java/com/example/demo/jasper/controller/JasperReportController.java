...
public class JasperReportController {
	...
	public ResponseEntity<ByteArrayResource> downloadUserReport(@PathVariable String format, HttpServletResponse response) throws JRException, IOException {
		log.info("downloadUserReport 로직 수행");
		
		 List<BoardVO2> boardList = boardService.getAllListForJasper();
	    ...
	    return ResponseEntity.ok()
	    		...
	    		.header(HttpHeaders.CONTENT_DISPOSITION, ContentDisposition.attachment().filename("boardList." + format)
